...
<div id="install">
  Per ricevere le notifiche, installate uno shortcut al nostro Sito sullo schermo. E' facile, basta toccare
  <img id="share" src="data:image/png;base64,${iOSShareBase64}"> e poi "Aggiungi a schermata Home".
</div>
